...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> BIO = createField(DSL.name("bio"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.users.image</code>.
     */
    public final TableField<UsersRecord, String> IMAGE = createField(DSL.name("image"), SQLDataType.VARCHAR, this, "");
